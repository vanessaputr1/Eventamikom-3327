@extends(request()->routeIs('organizer.*') ? 'layouts.organizer' : 'layouts.admin', [
    'title' => 'Kelola Event'
])
...
@php
    $routePrefix = request()->routeIs('organizer.*')
        ? 'organizer'
        : 'admin';
@endphp
...
<header class="flex justify-between items-center mb-10">
    ...
    <a href="{{ route($routePrefix . '.events.create') }}"
            ...
            <tbody class="divide-y border-t">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="{{ route($routePrefix.'.events.edit', $event->id) }}"
                ...
                @empty
                    ...
                    <tr>
                        ...
                        <td colspan="5"
                            class="px-8 py-12 text-center text-slate-400">
