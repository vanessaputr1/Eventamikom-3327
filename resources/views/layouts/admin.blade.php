    ...
    <aside class="w-64 bg-indigo-900 text-indigo-100 flex flex-col p-6 space-y-8 sticky top-0 h-screen">
        ...
        <div class="mt-auto">
            <form action="{{ route('admin.logout') }}" method="POST" class="px-4">
                @csrf
                <button type="submit" class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-slate-50 text-slate-900 rounded-2xl font-bold hover:bg-slate-100 transition">
