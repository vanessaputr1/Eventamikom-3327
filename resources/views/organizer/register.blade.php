...
<div class="min-h-screen flex items-center justify-center px-6 py-12">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-extrabold text-slate-900 mb-2">Daftar Organizer</h1>
            <p class="text-slate-500 font-medium">Daftar sebagai penyelenggara event</p>
        </div>
        ...
        <div class="mt-8 text-center">
            <p class="text-xs text-slate-500">Registrasi organizer akan ditinjau oleh Superadmin sebelum dapat mengelola event.</p>
        </div>
    </div>
</div>
@endsection