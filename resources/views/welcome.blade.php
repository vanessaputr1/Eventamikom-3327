...
<section id="events" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="flex gap-8 overflow-x-auto pb-4 scrollbar-hide">
        ...
        <div class="group min-w-[350px] max-w-[350px] bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
...
<section id="partners" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="text-center mb-14">
        ...
        <p class="text-slate-500 font-medium text-lg">
            Bekerja sama dengan partner terpercaya untuk event terbaik.
        </p>
    ...
    <div class="flex justify-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="{{ $partner->url }}"
                target="_blank"
                rel="noreferrer"
                class="group w-[320px] rounded-3xl border border-slate-200 bg-white p-8 text-center transition-all duration-300 hover:shadow-2xl hover:border-indigo-200 hover:-translate-y-1">

                <!-- Logo -->
                <div class="mx-auto mb-6 flex h-36 w-36 items-center justify-center overflow-hidden rounded-3xl bg-slate-100 p-5">
                ...
                <p class="text-sm text-indigo-600 font-semibold break-all">
                    {{ \Illuminate\Support\Str::limit($partner->url, 40) }}
                </p>
