...
<main class="max-w-3xl mx-auto px-6 py-20">
    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="mb-6 rounded-2xl bg-green-50 border border-green-200 p-5">
            ...
            <p class="text-sm text-green-600">
                ...
                Setelah Anda menekan tombol daftar,
                E-Ticket akan langsung dibuat secara otomatis.
            </p>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            <div class="mb-6 rounded-2xl bg-emerald-50 text-emerald-700 px-4 py-3 text-sm font-bold">
                Akun Google Anda sudah terdeteksi. Nama dan email otomatis terisi dari profil login.
            </div>
            ...
            <form action="{{ route('checkout.store', $event->id) }}"
                ...
                <button
                    type="submit"
                    class="w-full py-5 bg-green-600 text-white rounded-2xl font-black text-xl shadow-xl hover:bg-green-700 transition">
                ...
                <button
                    type="submit"
                    class="w-full py-5 bg-indigo-600 text-white rounded-2xl font-black text-xl shadow-xl shadow-indigo-200 hover:bg-indigo-700 transition">
